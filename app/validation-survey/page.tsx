 ...
 * WIE: Multi-step form mit 16 Fragen, conditional logic, KES 150 payment incentive
...
export default function ValidationSurveyPage() {
  ...
  const questions = [
    ...
    },
    {
      ...
      question: '4. Have you ever applied for a business loan?',
      type: 'radio',
      options: ['Yes', 'No']
    },
    {
      id: 'loan_outcome',
      section: 'Loan Experience',
      question: '5. If YES: What was the outcome?',
      type: 'radio',
      options: [
        'Approved',
        'Rejected',
        'Still waiting',
        'Never applied (skip this)'
      ]
    },
    {
      id: 'rejection_reason',
      section: 'Loan Experience',
      question: '6. If REJECTED: What reason were you given?',
      type: 'radio',
      options: [
        ...
        'Other/Don\'t know',
        'Not applicable (loan approved/not applied)'
      ]
    },
    ...
    },
    {
      id: 'concrete_problem',
      section: 'Current Record Keeping',
      question: '9. Tell us about ONE specific time when organizing your M-Pesa data caused problems. What happened?',
      type: 'textarea',
      placeholder: 'Example: "I lost a loan opportunity because it took me 3 days to organize my M-Pesa statements..."'
    },
    ...
    // SECTION 4: PAIN QUANTIFICATION
    {
      id: 'time_savings',
      section: 'Time & Cost',
      question: '10. If loan approval took 5 minutes instead of days/weeks, how much would that help your business?',
      type: 'radio',
      options: [
        'Not helpful',
        'Slightly helpful',
    ...
    // SECTION 5: SOLUTION FIT
    {
      id: 'solution_fit',
      section: 'Solution',
      question: '11. If you had an app that automatically analyzes your M-Pesa statements and shows: monthly income, expenses, and loan qualification - would that help?',
      type: 'radio',
      options: [
    ...
    },
    {
      id: 'solution_impact',
      section: 'Solution',
      question: '12. If YES to question 11: What would this change for you specifically?',
      type: 'textarea',
      placeholder: 'Example: "I could apply for loans faster and get approved more often..."'
    },
    ...
    // SECTION 6: WILLINGNESS TO PAY (3-PART)
    {
      id: 'current_spending',
      section: 'Pricing',
      question: '13. Do you currently pay for any tools to help with bookkeeping or loan applications?',
      type: 'radio',
      options: [
    ...
    },
    {
      id: 'free_trial',
      section: 'Pricing',
      question: '14. If M-Recon offered a FREE 1-month trial (no payment needed), would you try it?',
      type: 'radio',
      options: [
        'Yes, definitely',
        'Yes, probably',
    ...
    },
    {
      id: 'paid_commitment',
      section: 'Pricing',
      question: '15. After a free trial, if M-Recon costs KES 500/month, would you continue paying?',
      type: 'radio',
      options: [
    ...
    // SECTION 7: CONTACT
    {
      id: 'phone_number',
      section: 'Payment',
      question: '16. Your M-Pesa phone number (for KES 150 payment)',
      type: 'text',
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-t-2xl shadow-xl p-6 mt-8">
          ...
          <p className="text-gray-600 mb-4">
            Help us understand your business needs. Takes 6-8 minutes.
          </p>
